...
func test_normal_call():
	asserts.is_equal(0, test_subject_1.call_count_1, "Method1 called 0 times")
	asserts.is_equal(0, test_subject_1.call_count_2, "Method2 called 0 times")
	test_subject_1.test_method_1()
	asserts.is_equal(1, test_subject_1.call_count_1, "Method1 called 1 times")
	asserts.is_equal(0, test_subject_1.call_count_2, "Method2 called 0 times")
	test_subject_1.test_method_1()
	test_subject_1.test_method_2()
	asserts.is_equal(2, test_subject_1.call_count_1, "Method1 called 2 times")
	asserts.is_equal(1, test_subject_1.call_count_2, "Method1 called 1 times")

func test_notification():
	observable.notify(MESSAGE_A)
	asserts.is_equal(0, test_subject_1.call_count_1, "Method1 called 0 times on subject 1")
	asserts.is_equal(0, test_subject_2.call_count_1, "Method1 called 0 times on subject 2")
	asserts.is_equal(0, test_subject_1.call_count_2, "Method2 called 0 times on subject 1")
	asserts.is_equal(0, test_subject_2.call_count_2, "Method2 called 0 times on subject 2")
	
	test_subject_1.register(observable, MESSAGE_A, "test_method_1")
	observable.notify(MESSAGE_A)
	asserts.is_equal(1, test_subject_1.call_count_1, "Method1 called 1 times on subject 1")
	asserts.is_equal(0, test_subject_2.call_count_1, "Method1 called 0 times on subject 2")
	asserts.is_equal(0, test_subject_1.call_count_2, "Method2 called 0 times on subject 1")
	asserts.is_equal(0, test_subject_2.call_count_2, "Method2 called 0 times on subject 2")
	...
	asserts.is_equal(0, test_subject_2.call_count_1, "Method1 called 0 times on subject 2")
	asserts.is_equal(0, test_subject_1.call_count_2, "Method2 called 0 times on subject 1")
	asserts.is_equal(1, test_subject_2.call_count_2, "Method2 called 1 times on subject 2")
	
	test_subject_1.unregister(observable, MESSAGE_A)
	test_subject_2.register(observable, MESSAGE_A, "test_method_1")
	observable.notify(MESSAGE_A)
	asserts.is_equal(1, test_subject_1.call_count_1, "Method1 called 1 times on subject 1")
	asserts.is_equal(1, test_subject_2.call_count_1, "Method1 called 1 times on subject 2")
	asserts.is_equal(0, test_subject_1.call_count_2, "Method2 called 0 times on subject 1")
	asserts.is_equal(1, test_subject_2.call_count_2, "Method2 called 1 times on subject 2")
...
func test_priority():
	...
	asserts.is_equal("Called Method1 on subject1", observable.text, "Last called Method1 on subject 1")
	...
	observable.notify(MESSAGE_B)
	asserts.is_equal("Called Method2 on subject2", observable.text, "Last called Method2 on subject 2")
